  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute left-0 right-0 top-1/2 -translate-y-1/2 md:top-[18%] md:translate-y-0 z-20 pointer-events-none flex justify-center px-6"
        aria-hidden="true"
      >
        <img
          src={logoKrouselTypo}
          alt="THE K'ROUSEL"
          className="w-full max-w-[340px] sm:max-w-[480px] md:max-w-[560px] lg:max-w-[640px] h-auto drop-shadow-[0_4px_20px_rgba(0,0,0,0.55)]"
        />
      </motion.div>
